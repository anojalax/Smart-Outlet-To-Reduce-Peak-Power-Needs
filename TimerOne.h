   ...
   Interrupt and PWM utilities for 16 bit Timer1 on ATmega168328
   Original code by Jesse Tane for httplabs.ideo.com August 2008
   ...
   This is free software. You can redistribute it andor modify it under
   the terms of Creative Commons Attribution 3.0 United States License. 
   To view a copy of this license, visit httpcreativecommons.orglicensesby3.0us 
...
#include configknown_16bit_timers.h
...
#define F_TIMER (F_PLL2)
  ...
  public
   ...
   httpsgithub.comPaulStoffregenTimerOneissues17 
